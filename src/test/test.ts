...
import { CommandEntry, PlaySound, PlayTrack, Track } from "../index";
...
new Track([
  ...
  new CommandEntry(8 * 4, new PlayTrack(new Track([
    new CommandEntry(8 * 0, new PlaySound("block.note_block.harp", "record", 1, 2 ** (1 / 12))),
    new CommandEntry(8 * 1, new PlaySound("block.note_block.harp", "record", 1, 2 ** (3 / 12))),
    new CommandEntry(8 * 2, new PlaySound("block.note_block.harp", "record", 1, 2 ** (5 / 12))),
    new CommandEntry(8 * 3, new PlaySound("block.note_block.harp", "record", 1, 2 ** (6 / 12)))
  ])))
